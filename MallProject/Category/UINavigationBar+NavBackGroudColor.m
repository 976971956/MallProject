//
//  UINavigationBar+NavBackGroudColor.m
//  MallProject
//
...
@implementation UINavigationBar (NavBackGroudColor)
...
- (void)lt_setBackgroundColor:(UIColor *)backgroundColor
{
    if (!self.overlay) {
        ...
        self.overlay = [[UIView alloc] initWithFrame:CGRectMake(0, 0, ScreenW, JHNavHeight)];
