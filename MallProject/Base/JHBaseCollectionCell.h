...
@protocol JHBaseCollectionCellDelegate <NSObject>
...
@interface JHBaseCollectionCell : UICollectionViewCell

@property (nonatomic, weak) id<JHBaseCollectionCellDelegate> delegate;
